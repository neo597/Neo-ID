    ...
    >
      ...
      <div class="relative z-10 bg-black/80 backdrop-blur-sm px-4 py-3 flex items-center justify-between">
        <div class="flex items-center gap-3">
          ...
          <div>
            <h2 class="text-white font-semibold text-lg">Capturar Oreja para Reconocimiento</h2>
            <p class="text-white/70 text-sm">Apunta la oreja del neonato dentro del marco</p>
          </div>
        </div>
      ...
      <div class="flex-1 relative overflow-hidden">
        ...
        <div v-if="!capturedPhoto" class="absolute inset-0 flex items-center justify-center pointer-events-none">
          ...
          <div class="relative z-10">
            ...
            <div
              class="relative rounded-full shadow-2xl ring-4 ring-white/30 overflow-hidden border-4 border-blue-400"
            ...
            >
              ...
              <!-- Borde del marco -->
              <div
                class="absolute inset-0 rounded-full pointer-events-none border-3 border-blue-400"
            ...
            <div class="absolute -bottom-20 left-1/2 transform -translate-x-1/2 text-center w-64">
              <p class="text-white text-sm font-medium mb-1 drop-shadow-lg">
                Coloca la oreja dentro del marco
              </p>
